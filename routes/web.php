...
Route::group(['middleware' => ['web']], function () {
    ...
    // LENGUAJE
    // El método where() nos permite limitar el valor del parámetro {lang} solo a “en” o “es” para evitar que se asigne a la 
    // variable de sesión un idioma que no exista
