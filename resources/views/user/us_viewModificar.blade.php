    ...
    <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="form_register" method="POST" action="{{ route('us_modificar') }}" onsubmit="return checkSubmit_modificar();">
                    ...
                    <div id="div_flex">
                        ...
                        <div class="div_register_usernameName">
                            ...
                            <div class="div_register_usernameName">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Aurora" name="name" value="{{ old('name') }}" required autofocus disabled="true" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$">
                    ...
                    <div id="div_flex">
                        ...
                        <div class="div_register_usernameName">
                            ...
                            <div class="div_register_usernameName">
                                <input id="us_apellidopat" type="text" class="form-control{{ $errors->has('us_apellidopat') ? ' is-invalid' : '' }}" placeholder="López" name="us_apellidopat" value="{{ old('us_apellidopat') }}" required autofocus disabled="true" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$">
                        ...
                        <div class="div_register_usernameName">
                            ...
                            <div class="div_register_usernameName">
                                <input id="us_apellidomat" type="text" class="form-control{{ $errors->has('us_apellidomat') ? ' is-invalid' : '' }}" placeholder="Galicia" name="us_apellidomat" value="{{ old('us_apellidomat') }}" required autofocus disabled="true" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$">
                    ...
                    <div id="div_flex">
                        ...
                        <div class="div_register_usernameName">
                            ...
                            <div class="div_register_usernameName">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="amlopez@santander.com.mx" name="email" value="{{ old('email') }}" required disabled="true" pattern="^[_A-Za-z0-9-]+@+(santander.com.mx)$">
