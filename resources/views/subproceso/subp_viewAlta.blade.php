    ...
    <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="card-body"> 
                ...
                <form id="form_register" method="POST" action="{{ route('subp_alta') }}" onsubmit="return checkSubmit_alta_dom();">
                    @csrf
                    <br>
                    <div id="div_flex_modificar_expediente">
                        ...
                        <div id="div_boton_registrar" class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button id="boton_alta_dom" onclick="validarSubp()" type="submit" class="btn btn-primary">
