                ...
                <form id="form_register" method="POST" action="{{ route('register') }}"  onsubmit="return checkSubmit_alta_dom();">
                    ...
                    <div id="div_flex_modificar_expediente">
                        ...
                        <div id="div_boton_registrar" class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button id="boton_alta_dom" onclick="validar()" type="submit" class="btn btn-primary">@lang('boton.boton_registrar')</button>
                            </div>         
                        </div>
                    </div>
                    <br>
                    ...
                    <div id="div_flex">
                        ...
                        <div class="div_register_usernameName">
                            ...
                            <div class="div_register_usernameName">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="amlopez@santander.com.mx"  name="email" value="{{ old('email') }}" required pattern="^[_A-Za-z0-9-]+@+(santander.com.mx)$">
